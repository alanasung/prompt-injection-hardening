import json
from injrob.reporting.aggregate import aggregate_results, flatten_metrics
from injrob.reporting.tables import write_tables
from injrob.reporting.figures import write_caption, write_figures
