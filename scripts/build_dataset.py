...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("injrob.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from injrob.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"injrob.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/injrob/data/__init__.py under BUILDERS, or use data=synthetic "
