...
from injrob.configs.loader import register_schema
...
def _load_stage_registry(package: str = "injrob") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in injrob.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from injrob.configs.loader import config_to_dict, save_resolved_config
    from injrob.models.device import get_device
    from injrob.utils.logging import configure_logging
    from injrob.utils.reproducibility import set_seed
    from injrob.utils.run_manifest import create_run_dir, save_run_metadata
