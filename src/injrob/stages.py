"""Experiment stages for Role Inference From Style Versus Delimiters."""
...
from .injrob._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Role Inference From Style Versus Delimiters", "claims_gated": True})
