...
This note situates **Role Inference From Style Versus Delimiters** against the mentor-linked literature for
[Role Inference From Style Versus Delimiters](https://github.com/alanasung/prompt-injection-hardening).

## Positioning

Measure whether models trust writing style over structural role tags under injection.

The design hypothesis is: Measure whether models trust writing style over structural role tags under injection.
